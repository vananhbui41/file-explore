...
const classes = computed(() =>
    props.active
        ? 'flex items-center px-5 py-2 rounded-lg border-indigo-400 text-sm font-medium leading-5 text-indigo-700 bg-indigo-1000 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
